...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-ecomm';
        ...
        */
        ...
        return view('ecomm::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('ecomm.name'),
            'version' => config('settings.global.ecomm_version')??config('ecomm.version'),
            'is_dev' => config('ecomm.is_dev'),
        ];
