...
class PersonsController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['fillable']['columns'] = Person::getFillableColumns();
    ...
    //     {
    //         $taxonomies = Taxonomy::getTaxonomyByType($type);
    ...
    {
        try{
            return Person::updateList($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function listAction(Request $request, $type)
    {
        ...
        try{
            return Person::listAction($request, $type);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Person::deleteList($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Person::fillItem($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function createItem(Request $request)
    {
        try{
            ...
            return Person::createItem($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Person::updateItem($request,$id);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Person::deleteItem($request,$id);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return Person::itemAction($request,$id,$action);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
