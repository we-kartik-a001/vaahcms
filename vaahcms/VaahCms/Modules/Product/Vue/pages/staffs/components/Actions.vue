        ...
        <div :class="{'flex justify-between items-start': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button size="small"
                        ...
                        data-testid="staffs-actions-menu"
                        aria-haspopup="true"
            ...
            <div >
                ...
                <InputGroup>
                    <InputText v-model="store.query.filter.q"
                               ...
                               data-testid="staffs-actions-search"
                               placeholder="Search"/>
                    <Button @click="store.delayedSearch()"
                            size="small"
                            data-testid="staffs-actions-search-button"
                            icon="pi pi-search"/>
                    <Button v-if="!store.isMobile"
                            ...
                            data-testid="staffs-actions-show-filters"
                    >
                    ...
                    <Button
                            ...
                            data-testid="staffs-actions-reset-filters"
                            size="small"
                    ...
                    <Button
                            ...
                            data-testid="staffs-actions-bulk-menu"
                            aria-haspopup="true"
