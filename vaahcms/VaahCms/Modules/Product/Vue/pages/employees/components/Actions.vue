        ...
        <div :class="{'flex justify-between items-start': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button size="small"
                        ...
                        data-testid="employees-actions-menu"
                        aria-haspopup="true"
            ...
            <div >
                ...
                <InputGroup>
                    <InputText v-model="store.query.filter.q"
                               ...
                               data-testid="employees-actions-search"
                               placeholder="Search"/>
                    <Button @click="store.delayedSearch()"
                            size="small"
                            data-testid="employees-actions-search-button"
                            icon="pi pi-search"/>
                    <Button v-if="!store.isMobile"
                            as="router-link"
                            :to="`/employees/filters`"
                            type="button"
                            size="small"
                            :disabled="Object.keys(route.params).length"
                            data-testid="employees-actions-show-filters"
                    >
                    ...
                    <Button
                            ...
                            data-testid="employees-actions-reset-filters"
                            size="small"
                    ...
                    <Button
                            ...
                            data-testid="employees-actions-bulk-menu"
                            aria-haspopup="true"
